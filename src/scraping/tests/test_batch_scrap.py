...
def register_sections(monkeypatch):
    monkeypatch.setattr("scraping.scrapers.batch_scraper.dismiss_overlay", lambda *_: True)
    monkeypatch.setattr("scraping.scrapers.batch_scraper.PageScrap.scrap_cast_page", lambda *_: SECTION_VALUE["cast"])
    monkeypatch.setattr("scraping.scrapers.batch_scraper.PageScrap.scrap_crew_page", lambda *_: SECTION_VALUE["crew"])
    monkeypatch.setattr("scraping.scrapers.batch_scraper.PageScrap.scrap_details_page", lambda *_: SECTION_VALUE["details"])
    monkeypatch.setattr("scraping.scrapers.batch_scraper.PageScrap.scrap_genres_themes_page", lambda *_: SECTION_VALUE["genres"])
    monkeypatch.setattr("scraping.scrapers.batch_scraper.PageScrap.scrap_tmdb_url", lambda *_: SECTION_VALUE["tmdb"])
...
def test_scrape_one_handles_overlay_failures(monkeypatch):
    ...
    monkeypatch.setattr("scraping.scrapers.batch_scraper.dismiss_overlay", fail)
    context = DummyContext()
    tmdb_page = DummyTMDBPage()
...
def test_scrape_one_calls_tmdb_without_reusable_page(monkeypatch):
    ...
    monkeypatch.setattr("scraping.scrapers.batch_scraper.PageScrap.scrap_tmdb_url", tmdb_stub)
...
def test_main_runs_with_mocked_playwright(monkeypatch):
    ...
    monkeypatch.setattr("scraping.scrapers.batch_scraper.sync_playwright", fake_sync_playwright)
    monkeypatch.setattr("scraping.scrapers.batch_scraper.scrape_one", fake_scrape_one)
    monkeypatch.setattr(builtins, "open", lambda *args, **kwargs: DummyFile())
    monkeypatch.setattr("scraping.scrapers.batch_scraper.json.dump", fake_dump)
